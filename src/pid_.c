...
void initPid(void)/*{{{*/
{
    ...
    pid_pos.param.Kp   = 14;
    pid_pos.param.Ki   = 0.002;
    pid_pos.param.Kd   = 0.800;
    pid_pos.param.Kr   = 1.0000;
    ...
    pid_spd.param.Kp   =  7;
    pid_spd.param.Ki   = 0.0019;
    pid_spd.param.Kd   = 0.5;
    pid_spd.param.Kr   = 1.0000;
    pid_spd.param.Km   = 0.7000;

...
set yrange [-0.2:1.2];
set autoscale
plot '< tail -n 500 log.txt' every ::1 using 1:2 with   lines linestyle 3 notitle, \
     '< tail -n 500 log.txt' every ::1 using 1:3 with   lines linestyle 4 notitle,
...
set yrange [0:0.15];
set autoscale
plot '< tail -n 500 log.txt' every ::1 using 1:6 with lines  linestyle 1 notitle, \
     '< tail -n 500 log.txt' every ::1 using 1:7 with lines  linestyle 2 notitle

...
set yrange [0:0.15];
set autoscale
plot '< tail -n 100 log.txt' every ::1 using 1:2 smooth acsplines linestyle 1 notitle

set ylabel "rev/min"
set title "speed"
set yrange [0.0005:0.0015];
set autoscale
plot '< tail -n 100 log.txt' every ::1 using 1:3 smooth acsplines linestyle 2 notitle

set ylabel "pos 0-1"
set title "pos"
set yrange [-0.2:1.2];
set autoscale
plot '< tail -n 100 log.txt' every ::1 using 1:4 with   lines linestyle 3 notitle
